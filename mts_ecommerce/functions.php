...
define( 'MTS_THEME_VERSION', '1.5.10' );
...
if ( function_exists( 'register_sidebar' ) ) {
	function mts_register_sidebars() {
		...
		if ( ! empty( $mts_options['mts_first_footer'] ) ) {
			if ( empty( $mts_options['mts_first_footer_num'] ) ) {
				$mts_options['mts_first_footer_num'] = 4;
			}
...
function mts_custom_sidebar() {
	...
	if ( is_single() && ! empty( $mts_options['mts_sidebar_for_post'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_post'];
	}
	if ( is_page() && ! empty( $mts_options['mts_sidebar_for_page'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_page'];
	}
	// Archives
	if ( is_archive() && ! empty( $mts_options['mts_sidebar_for_archive'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_archive'];
	}
	if ( is_category() && ! empty( $mts_options['mts_sidebar_for_category'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_category'];
	}
	if ( is_tag() && ! empty( $mts_options['mts_sidebar_for_tag'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_tag'];
	}
	if ( is_date() && ! empty( $mts_options['mts_sidebar_for_date'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_date'];
	}
	if ( is_author() && ! empty( $mts_options['mts_sidebar_for_author'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_author'];
	}
	// Other
	if ( is_search() && ! empty( $mts_options['mts_sidebar_for_search'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_search'];
	}
	if ( is_404() && ! empty( $mts_options['mts_sidebar_for_notfound'] ) ) {
		$sidebar = $mts_options['mts_sidebar_for_notfound'];
	}
...
function mts_enqueue_css() {
	...
	$custom_css     = "
        ...
        .woocommerce div.product .stock, .woocommerce .woocommerce-info a, .woocommerce .woocommerce-message a, .widget .wpt_widget_content .tab-content li a:hover, .primary-slider .slide-caption .slide-content-4 span { color: {$mts_options['mts_color_scheme2']} }
        ...
        .f-widget .readMore a, #move-to-top, .tagcloud a:hover, .currenttext, .pagination a:hover, .pagination  .nav-previous a:hover, .pagination .nav-next a:hover, #load-posts a:hover, #site-header #primary-navigation .navigation a:before, .mts-ad .ad-button .button, .woocommerce .woocommerce-ordering .e-comm.active, .woocommerce .woocommerce-ordering .e-comm:hover, .woocommerce-page .woocommerce-ordering .e-comm.active, .woocommerce-page .woocommerce-ordering .e-comm:hover, .woocommerce a.button:hover, .woocommerce-page a.button:hover, .woocommerce .button:hover, .woocommerce-page .button:hover, .woocommerce input.button:hover, .woocommerce-page input.button:hover, .woocommerce #content input.button:hover, .woocommerce-page #content input.button:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce .button:hover, .woocommerce input.button:hover, .woocommerce-page #respond input#submit:hover, .woocommerce-page a.button:hover, .woocommerce-page .button:hover, .woocommerce-page input.button:hover, .mts-product-badges .new-badge, #searchform #searchsubmit:hover, .woocommerce .product-hover .ec_action_button, .product-hover .ec_action_button, .mts-cart-button-wrap:hover .mts-cart-button .mts-cart-icon, .mts-wishlist-link:hover .mts-wishlist-icon, .woocommerce .widget_price_filter .price_slider_amount .button, .woocommerce .widget_price_filter .ui-slider .ui-slider-handle:last-child, .product-hover .look a:hover, .product-hover .details a:hover, .woocommerce div.product .woocommerce-tabs ul.tabs li a:hover span, .woocommerce .button.alt, .woocommerce .button.alt:hover, .woocommerce .cart-actions .checkout-button, .woocommerce #payment #place_order, .primary-slider .owl-controls .owl-dot.active span, .primary-slider .owl-controls .owl-dot:hover span, .owl-controls .owl-dot.active span, .owl-controls .owl-dot:hover span, .effect-default .product-hover .look a:hover, .effect-default .product-hover .details a:hover, #commentform input#submit:hover, .woocommerce nav.woocommerce-pagination ul li span.current, .woocommerce-page nav.woocommerce-pagination ul li span.current, .woocommerce #content nav.woocommerce-pagination ul li span.current, .woocommerce-page #content nav.woocommerce-pagination ul li span.current, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce-page nav.woocommerce-pagination ul li a:hover, .woocommerce #content nav.woocommerce-pagination ul li a:hover, .woocommerce-page #content nav.woocommerce-pagination ul li a:hover { background: {$mts_options['mts_color_scheme2']}; color: #fff; }
...
function ajax_mts_search() {
	...
	if ( ! empty( $query ) && $search_query->have_posts() ) :
		...
		endwhile;
		echo '</ul>';
		$all_results_link = apply_filters( 'ecommerce_all_results_url', add_query_arg( array(
			's'         => $query,
			'post_type' => $type,
		), home_url( '/' ) ) );
...
if ( mts_isWooCommerce() ) {
	...
	if ( is_admin() && isset( $_GET['activated'] ) && $pagenow == 'themes.php' ) {
		add_action( 'init', 'mythemeshop_woocommerce_image_dimensions', 1 );
	}
	...
	function woocommerce_template_loop_category_title( $category ) {
        ...
        <div class="browse-category-info">
			...
			<?php if ( $category->count > 0 ) {
				echo apply_filters( 'woocommerce_subcategory_count_html', '<div class="browse-category-products">' . $category->count . __( ' Products', MTS_THEME_TEXTDOMAIN ) . '</div>', $category );
			} ?>
        </div>
		<?php
	}
	...
	function mts_attribute_tax_edit_form_fields( $tag, $taxonomy ) {
        ...
        <tr class="form-field">
            ...
            <td>
                <input type="text" id="ps_color_hex_code" name="ps_color_hex_code" class="mts-color-picker-field"
			...
			while ( $wishlist_query->have_posts() ) : $wishlist_query->the_post();
                ...
                <tr class="mts-wishlist-table-row">
                    <td class="product-remove">
                        <a href="#" data-product-id="<?php echo $pr_id; ?>" class="mts-remove-from-wishlist remove"
                           title="<?php _e( 'Remove this product', MTS_THEME_TEXTDOMAIN ) ?>">&times;</a>
                    </td>
	...
	function mts_quick_look() {
		$id = $_POST['product_id']; ?>
        <div id="mts-product-popup-<?php echo $id; ?>"
             class="mts-product-popup woocommerce white-popup mfp-hide clearfix">
                            ...
                            <div class="summary entry-summary">
                                ...
                                <div class="popup-product-content">
                                    ...
                                    <div class="popup-product-buttons">
                                        ...
                                        <a href="<?php echo esc_url( get_the_permalink() ); ?>" class="button"><i
                                                    class="fa fa-search"></i><?php _e( 'View Details', MTS_THEME_TEXTDOMAIN ); ?>
                                        </a>
										<?php global $product;
...
function mts_add_extra_social_links( $user ) {
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td><input type="text" name="behance"
        ...
        <tr>
            ...
            <td><input type="text" name="pinterest"
        ...
        <tr>
            ...
            <td><input type="text" name="stumbleupon"
                       value="<?php echo esc_attr( get_the_author_meta( 'stumbleupon', $user->ID ) ); ?>"
                       class="regular-text"/></td>
        </tr>
        <tr>
...
function mts_correct_homepage_sections_import( $item, $key, $data ) {
	...
	if ( ! in_array( $key, array( 'mts_custom_slider', 'lookbook_images', 'brand_images' ) ) ) {
		return $item;
	}

...
<div class="featured-section home-section clearfix featured-blog-posts">
	<div class="container">
		<header class="featured-section-header clearfix featured-blog-posts-header">
			...
			<div class="readMore">
				<a href="<?php echo esc_url( apply_filters( 'ecommerce_blog_page_redirect', get_permalink( get_page_by_path( 'blog' ) ) ) ); ?>" rel="nofollow"><?php _e('View All', MTS_THEME_TEXTDOMAIN ); ?></a>
			</div>
		</header>
		<?php 
		$args = array(
		...
		<?php while ( $latest_posts->have_posts() ) : $latest_posts->the_post(); ?>
			<article class="featured-blog-post">
				<div class="featured-blog-post-inner">
					<a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="nofollow" class="featured-image">

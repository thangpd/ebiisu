...
if ( mts_isWooCommerce() ) {
	if ( isset( $mts_options['mts_home_tabs'] ) && is_array( $mts_options['mts_home_tabs'] ) && array_key_exists( 'enabled', $mts_options['mts_home_tabs'] ) ) {
		...
		$tabs = array( 'best_sellers_tab' => __('Bán chạy', MTS_THEME_TEXTDOMAIN), 'new_products_tab' => __('Hàng mới', MTS_THEME_TEXTDOMAIN), 'top_rated_tab' => __('Đánh giá cao', MTS_THEME_TEXTDOMAIN) );
	}
	?>

	...
	$sections[] = array(
		...
		'fields' => array(
					...
					array(
						...
						array(
							...
							'options'  => array(
								'2co'          => array(
									'name' => 'Two Check Out',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/2co.png'
								),
								'amex'         => array(
									'name' => 'American Express',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/amex.png'
								),
								'cirrus'       => array(
									'name' => 'Cirrus',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/cirrus.png'
								),
								'delta'        => array(
									'name' => 'Delta',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/delta.png'
								),
								//'diners'       => array( 'name'=> 'Diners', 'img' => NHP_OPTIONS_URL.'img/credit-cards/diners.png' ),
								'discover'     => array(
									'name' => 'Discover',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/discover.png'
								),
								...
								'mastercard'   => array(
									'name' => 'MasterCard',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/mastercard.png'
								),
								'moneybookers' => array(
									'name' => 'Money Bookers',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/moneybookers.png'
								),
								'paypal'       => array(
									'name' => 'PayPal',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/paypal.png'
								),
								'visa'         => array(
									'name' => 'VISA',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/visa.png'
								),
								'switch'       => array(
									'name' => 'Switch',
									'img'  => NHP_OPTIONS_URL . 'img/credit-cards/switch.png'
								),
			...
			array(
				...
				'options'  => array(
					'color'         => '',
					// false to disable, not needed otherwise
					'image_pattern' => $mts_patterns,
					// false to disable, array of options otherwise ( required !!! )
					'image_upload'  => '',
					// false to disable, not needed otherwise
					'repeat'        => array(),
					// false to disable, array of options to override default ( optional )
					'attachment'    => array(),
					// false to disable, array of options to override default ( optional )
					'position'      => array(),
					// false to disable, array of options to override default ( optional )
			...
			array(
				...
				'subfields' =>
					array(
						...
						array(
							'id'       => 'mts_custom_slider_button_text',
							'type'     => 'text',
	...
	$sections[] = array(
		...
		'fields' => array(
			array(
				...
				'options'  => array(
					'top'      => __( 'Above Content', MTS_THEME_TEXTDOMAIN ),
					'bottom'   => __( 'Below Content', MTS_THEME_TEXTDOMAIN ),
					'floating' => __( 'Floating', MTS_THEME_TEXTDOMAIN )
				),

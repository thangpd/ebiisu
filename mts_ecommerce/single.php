								...
								case 'author':
									...
									<div class="postauthor">
										...
										<?php
											...
											if(!empty($facebook) || !empty($twitter) || !empty($google) || !empty($behance) || !empty($pinterest) || !empty($stumbleupon) || !empty($linkedin) || !empty($author_url)){
												echo '<div class="author-social">';
													...
													if(!empty($google)){
														echo '<a href="'.esc_url($google).'" class="social-gplus"><i class="fa fa-google-plus"></i></a>';
													}
													if(!empty($behance)){
										...
										<div class="readMore">
											<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="" rel="nofollow"><?php _e('More Articles By', MTS_THEME_TEXTDOMAIN ); echo ' '; the_author_meta( 'nickname' ); ?></a>
										</div>
									</div>
									<?php
								break;
